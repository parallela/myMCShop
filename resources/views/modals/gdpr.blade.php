<!-- Modal -->
<div class="modal fade" id="gdpr" tabindex="-1" role="dialog" aria-labelledby="gdpr" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Effective date: August 10, 2018</p>


                <p>myMCShop ("us", "we", or "our") operates the https://mymcshop.com website (the "Service").</p>
                ...
                <p>We use your data to provide and improve the Service. By using the Service, you agree to the
                    ...
                    Conditions, accessible from https://mymcshop.com</p>
                ...
                <p>myMCShop uses the collected data for various purposes:</p>
                <ul>
                ...
                <p>If you are located outside Bulgaria and choose to provide information to us, please note that we
                    transfer the data, including Personal Data, to Bulgaria and process it there.</p>
                ...
                <p>myMCShop will take all steps reasonably necessary to ensure that your data is treated securely and in
                ...
                <p>myMCShop may disclose your Personal Data in the good faith belief that such action is necessary
                    to:</p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of myMCShop</li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p>Statcounter is a web traffic analysis tool. You can read the Privacy Policy for Statcounter
                            here: <a
                                    href="https://statcounter.com/about/legal/">https://statcounter.com/about/legal/</a>
                        </p>
                    </li>
                </ul>
                ...
                <ul>
                    <li>By email: support@mymcshop.com</li>
                    <li>By visiting this page on our website: https://mymcshop.com/contact</li>

                </ul>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-danger" data-dismiss="modal"><b
                            class="fa fa-times"></b> @lang('content.close')
                </button>
                <button type="button" class="btn btn-success" onclick="acceptGDPR()" data-dismiss="modal"><b
                            class="fa fa-check"></b> @lang('content.accept')</button>
            </div>
        </div>
    </div>
</div>
